...
metadata = {
    "protocolName": "Opentrons OT-2 pipetting performance script (P300)",
...
MAX_PIPETTE_VOLUME = 300  # in µl
DYE_VOLUME = 10  # in µl (per well)
...
RIGHT_PIPETTE = "p300_multi_gen2"
TIP_RACKS = "opentrons_96_tiprack_300ul"
